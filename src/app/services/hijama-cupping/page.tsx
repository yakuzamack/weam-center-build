        ...
        <section className="py-16 max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <div className="w-full h-80 bg-gradient-to-r from-green-100 to-emerald-100 rounded-xl shadow-lg flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-green-600 font-semibold">الحجامة الطبية</p>
                  <p className="text-green-500 text-sm">Hijama Cupping</p>
                </div>
              </div>
            </div>
          </div>
